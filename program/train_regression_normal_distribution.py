...
#out_path = 'resource/cv_regression_model/remove_%d'%test_k
out_path = 'resource/cv_regression_normal_distribution_model/remove_%d'%test_k
...
# Prepare model
import alex_model_for_regression_normal_distribution
model = alex_model_for_regression_normal_distribution.Alex()
